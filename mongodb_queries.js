...
db.restaurants.find({ $or: [{ cuisine: { $nin: ["American", "Chinese"], $regex: /fish/i } }, { name: /^Wil/ }]}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1, _id: 0 })
...
db.restaurants.find({ name: /mi/i }, { name: 1, borough: 1, "address.coord": 1, cuisine: 1, _id: 0 })
